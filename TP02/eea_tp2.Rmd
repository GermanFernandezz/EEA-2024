...
- Los coeficientes más significativos son:
  - Goles: +2,189,855 por gol (p-value < 2e-16)
  - Asistencias: +2,152,607 por asistencia (p-value < 2e-16)
...
- Los coeficientes más significativos son:
  - Goles: +0.116 (p-value < 2e-16), indica un aumento del 12.3% en el precio por cada gol
  - - Asistencias: +0.173 (p-value < 2e-16), indica un aumento estadísticamente significativo del 18.9% en el precio por cada asistencia
...
- El modelo utiliza la transformación logarítmica de la variable precio y mantiene las mismas variables predictoras
- Los coeficientes más significativos son:
  - Goles: +0.111 (p-value < 2e-16), indica un aumento estadísticamente significativo del 11.7% en el precio por cada gol
  - Asistencias: +0.170 (p-value < 2e-16), indica un aumento estadísticamente significativo del 18.5% en el precio por cada asistencia
  - Edad: efecto cuadrático significativo (p-value < 2e-16)
