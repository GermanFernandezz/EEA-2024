...
metricas <- rbind(metricas, metricas_robusto_test)
metricas <- rbind(metricas, metricas3_test)
metricas <- rbind(metricas, metricas4_1_test)
metricas <- rbind(metricas, metricas4_test)
metricas <- rbind(metricas, metricas5_1_test)
metricas <- rbind(metricas, metricas5_test)
metricas <- rbind(metricas, metricas6_1_test)
metricas <- rbind(metricas, metricas6_test)
metricas <- rbind(metricas, metricas7_1_test)
metricas <- rbind(metricas, metricas7_test)
metricas <- rbind(metricas, metricas8_1_test)
...
modelitos <- c(rep("Clasico - Precio",3),
               ...
               rep("Robusto - Precio - psi = hampel",3),
               rep("Robusto - log(Precio) - psi = hampel",3),
               rep("Robusto - Precio - psi = ggw",3),
...
ggplot(df_metricas %>% filter(metrica == "rmse"), 
  ...
  geom_text(aes(label = scales::comma(valor)), 
            ...
            hjust = 1,  # Texto dentro das barras
